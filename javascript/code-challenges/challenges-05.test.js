...
const addValues = (arr) => {
  let myArray = arr.reduce((item , value)=>{
    return (item += value);
  },0)
  return myArray;
};
...
const addPurchases = (arr) => {
 let newArr = arr.reduce((item , value)=>{
...
const reversedString = (str) => {
  return str.split('').reduce((a,value)=> value + a);
};
